            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">
                  Bạn có chắc chắn muốn duyệt đơn hàng này? Đơn hàng sẽ chuyển sang trạng thái "Đã duyệt" và có thể được phân công cho nhân viên kho.
                </p>
              </div>
            </div>
          </div>
