...
export default function DeletePalletConfirmModal({
    isOpen,
    onClose,
    onConfirm,
    palletId,
    ...
    return createPortal(
        ...
        >
            <div
                className="w-full max-w-lg mx-4 bg-white rounded-xl shadow-2xl border border-gray-100"
            ...
            >
                ...
                <div className="p-8 text-center">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed">
                        Bạn có chắc chắn muốn xóa pallet không mong đợi này không?
                        <br />
