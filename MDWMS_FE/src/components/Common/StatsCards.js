    ...
    <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 ${className}`}>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="text-sm font-medium text-slate-600 mb-1">{totalLabel}</div>
            ...
            <div className="w-16 h-8 relative group">
              <svg width="64" height="32" viewBox="0 0 64 32" className="w-full h-full">
                ...
                <path
                  ...
                  opacity="0.1"
                />
                {/* Main trend line with wave pattern */}
                <path
      ...
      <Card className="bg-gray-50 border border-slate-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="text-sm font-medium text-slate-600 mb-1">{activeLabel}</div>
      ...
      <Card className="bg-gray-50 border border-slate-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="text-sm font-medium text-slate-600 mb-1">{inactiveLabel}</div>
