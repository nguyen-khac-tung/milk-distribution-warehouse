          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Gửi yêu cầu xuất hủy để chờ phê duyệt
              </p>
            </div>
          </div>
          <button
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-700">
                  Bạn có chắc chắn muốn nộp yêu cầu xuất hủy này? Yêu cầu sẽ chuyển sang trạng thái "Chờ duyệt" và cần được phê duyệt trước khi có thể tiếp tục xử lý.
                </p>
              </div>
            </div>
          </div>
