...
export const ROLE_PERMISSIONS = {
    ...
    [ROLES.WAREHOUSE_MANAGER]: [
        ...
        PERMISSIONS.STOCKTAKING_VIEW, PERMISSIONS.STOCKTAKING_VIEW_WM, PERMISSIONS.STOCKTAKING_CREATE, PERMISSIONS.STOCKTAKING_UPDATE, PERMISSIONS.STOCKTAKING_VIEW_DETAILS,
        PERMISSIONS.REPORT_VIEW, PERMISSIONS.REPORT_EXPORT
    ],
