...
import { ArrowLeft, Printer, CheckCircle, Clock, AlertCircle, ChevronDown, ChevronUp, RefreshCw, Barcode, Package, Send, ShieldCheck, MapPin, X, Search } from 'lucide-react';
        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-7xl mx-auto py-6">
                <div className="space-y-6">
                    ...
                    {isWarehouseStaff && goodsIssueNote.goodsIssueNoteDetails && goodsIssueNote.goodsIssueNoteDetails.length > 0 && (
                        <Card className="bg-white border border-gray-200 shadow-sm">
